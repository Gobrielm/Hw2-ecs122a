...
$dp[i, j, k] \doteq (p,w)$ where w is a running total for weight of some previous CDs, cassettes, vinyls, bigger than i, j, and k. P is the minimum number of packages needed to store 1..i, 1..j, and 1..k.\\
